...
@section('content')
    <main class="flex flex-row h-[100vh] ">
        ...
        <div class="w-[80%] h-[100vh] overflow-auto bg-zinc-950">
            <h1 class="text-white text-center text-2xl m-8">Nossos Modelos</h1>
            <div id="accordion-collapse" data-accordion="collapse" class="w-[90%] m-auto mb-8">
                ...
                <div id="accordion-collapse-body-1" class="hidden bg-zinc-900"
                    ...
                    <div class=" border-gray-800 w-[90%] m-auto pb-8 rounded-xl flex flex-col mb-8">
                        ...
                        <div class="grid grid-cols-4 gap-16 m-auto  justify-center items-center">
                            <div
                                class="border w-[300px] row-span-1 h-[500px] flex flex-nowrap flex-col justify-center items-center border-gray-300  bg-gray-700 p-4 rounded-md ">
                                                ...
                                                <div class="p-6 space-y-6">
                                                    ...
                                                    <div id="default-carousel" class="relative w-full"
                                                        ...
                                                        <div class="relative w-full overflow-hidden rounded-lg md:h-96">
                                                            <!-- Item 1 -->
                                                            <div class="hidden duration-700 ease-in-out border" data-carousel-item>
                                                    ...
                                                    <div class="flex gap-4 justify-center">
                                                        <div>
                                                            ...
                                                            <table class=" m-auto text-sm text-white bg-gray-800 text-left">


                                                                <tr class=" text-center">
                                                                    <th scope="row" class="px-6 py-3 border">DESCRIÇÃO</th>
                                                                    <th scope="row" class="px-6 py-3 border">DETALHE</th>

                                                                </tr>

                                                                    <tr class="text-center">
                                                                        <td scope="row" class="px-6 py-4 border">CALIBRE</th>
                                                                        <td scope="row" class="px-6 py-4 border">9MM (9X19)</td>
                                                                    </tr>

                                                                    <tr class="text-center">
                                                                        <td scope="row" class="px-6 py-4 border">CANO</th>
                                                                        <td scope="row" class="px-6 py-4 border">94MM / 3.7 / 6 RAIAS À DIREITA</td>
                                                                    </tr>

                                                                    <tr class="text-center">
                                                                        <td scope="row" class="px-6 py-4 border">PESO</th>
                                                                        <td scope="row" class="px-6 py-4 border">785g / 27,69oz</td>
                                                                    </tr>

                                                                    <tr class="text-center">
                                                                        <td scope="row" class="px-6 py-4 border">AÇÃO</th>
                                                                        <td scope="row" class="px-6 py-4 border">Strike Fire</td>
                                                                    </tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <table class=" m-auto text-sm text-white bg-gray-800 text-left">
                                                                ...
                                                                <tr class="text-center">
                                                                    <td scope="row" class="px-6 py-4 border">ESPÉCIE</th>
                                                                    <td scope="row" class="px-6 py-4 border">PISTOLA</td>
                                                                </tr>

                                                                <tr class="text-center">
                                                                    <td scope="row" class="px-6 py-4 border">MARCA</th>
                                                                    <td scope="row" class="px-6 py-4 border">TAURUS</td>
                                                                </tr>

                                                                <tr class="text-center">
                                                                    <td scope="row" class="px-6 py-4 border">PREÇO</th>
                                                                    <td scope="row" class="px-6 py-4 border">4.000,00</td>
                                                                </tr>
                ...
                <div id="accordion-collapse-body-2" class="hidden bg-gray-900"
                    aria-labelledby="accordion-collapse-heading-2" class="">
                    <div class=" border-gray-800 w-[90%] m-auto pb-8 rounded-xl flex flex-col mb-8">
                        <h2 class="text-center m-4 text-2xl text-white">Pistolas</h2>
                        <div class="grid grid-cols-4 gap-16 m-auto  justify-center items-center">
                ...
                <div id="accordion-collapse-body-3" class="hidden bg-gray-900"
                    aria-labelledby="accordion-collapse-heading-3" class="">
                    <div class=" border-gray-800 w-[90%] m-auto pb-8 rounded-xl flex flex-col mb-8">
                        <h2 class="text-center m-4 text-2xl text-white">Pistolas</h2>
                        <div class="grid grid-cols-4 gap-16 m-auto  justify-center items-center">
