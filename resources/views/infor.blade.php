@extends('template')
@section('content')
<img src="../imgs/capa-infor.jpg" alt="" />

<div class="flex justify-center flex-col m-8">
  <h1 class="text-center font-bold mb-8 text-6xl">
  ...
  <span
    >Estes processos são regulados pela Portaria nº 069/2019 - GAB. CMDº
    (Publicada no Adti. ao BG 078 II - 24 ABRIL 2019).</span
  >
</div>


<div id="accordion-collapse" data-accordion="collapse" class="w-[70%] m-auto">
  <h2 id="accordion-collapse-heading-1">
    <button
      type="button"
      class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-900"
      data-accordion-target="#accordion-collapse-body-1"
      aria-expanded="true"
      aria-controls="accordion-collapse-body-1"
    >
      <span class="text-blue-600">AQUISIÇÃO DE ARMA DE FOGO - ATIVA</span>
      <svg
        data-accordion-icon
  ...
  >
    ...
    >
      <span
        >(Obs: OS DOCUMENTOS DEVEM SER ESCANEADOS NESSE SEGUINTE ORDEM, MAS
        A CERTIDÃO, QUE ESTÁ NO ITEM 00, DEVE FICAR NO FINAL DO
        PROCESSO.)</span
      ><br />

      <ul
        class="max-w-md space-y-1 text-white list-disc list-inside dark:text-gray-400 p-4"
      >
        <li>
          00 - Capa e certidão, devidamente preenchida pelo computador.
          <a
            class="text-blue-600"
            href="../Docs/Capa de Processo de Aquisição.docx"
            download
          >
        ...
        <li>
          ...
          <a class="text-blue-600" href="../Docs/dec_cmt_4.doc" download
            >(Modelo)</a
          >
        ...
        <li>
          ...
          <a
            class="text-blue-600"
            href="../Docs/Declaração_de_Residência.doc"
            download
            >(Baixe aqui)</a
          >
        </li>
        ...
        <li>
          ...
          <ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
            <li>
              <a href="https://portal.trf1.jus.br/Servicos/Certidao/"
                >JUSTIÇA FEDERAL;</a
              >
            </li>
            <li>
              <a
                href="https://consultas.tjpa.jus.br/certidao/pages/pesquisaGeralCentralCertidao.action"
                >JUSTIÇA ESTADUAL;</a
              >
            </li>
            <li>
              <a
                href="https://www.stm.jus.br/servicos-stm/certidao-negativa/emitir-certidao-negativa"
                >JUSTIÇA MILITAR FEDERAL;</a
              >
            </li>
            <li>
              <a
                href="https://consultas.tjpa.jus.br/certidaomilitar/pages/InicioCertidao.action"
                >JUSTIÇA MILITAR ESTADUAL;</a
              >
            </li>
            <li>
              <a
                href="https://www.tse.jus.br/servicos-eleitorais/certidoes/certidao-de-crimes-eleitorais"
                >JUSTIÇA ELEITORAL;</a
              >
            </li>
            <li>
              <a href="https://antecedentes.policiacivil.pa.gov.br/consulta"
                >POLÍCIA CIVIL;</a
              >
            </li>
  ...
  <h2 id="accordion-collapse-heading-2">
    <button
      type="button"
      class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
      data-accordion-target="#accordion-collapse-body-2"
      aria-expanded="false"
      aria-controls="accordion-collapse-body-2"
    >
      <span class="text-blue-600"
        >AQUISIÇÃO DE ARMA DE FOGO - RESERVA REMUNERADA E REFORMADOS</span
      >
      <svg
        data-accordion-icon
  ...
  >
    <div class="border border-b-0 border-gray-200 p-4 dark:border-gray-700">
...
<div class="overflow-x-auto m-4 border">
  <h2 class="text-center mb-2 font-bold">DADOS PARA GERAÇÃO DA GRU.</h2>
  <table class="w-[70%] m-auto text-sm border text-left">
    <thead
      class="text-xs border text-gray-900 uppercase dark:text-gray-400"
    >
